const index = 6;
let component_cache;
const component = async () => component_cache ??= (await import('./_page.svelte-kinL18_x.js')).default;
...
const stylesheets = ["_app/immutable/assets/SponsorForm.qnJzoxRE.css","_app/immutable/assets/6.BHwZyL4X.css"];
const fonts = [];

export { component, fonts, imports, index, stylesheets };
//# sourceMappingURL=6-CTGll4IV.js.map
