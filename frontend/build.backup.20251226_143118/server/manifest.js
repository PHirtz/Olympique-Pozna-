	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('./chunks/_server-PPzNmrgh.js'))
			},
			{
				id: "/camps",
				pattern: /^\/camps\/?$/,
