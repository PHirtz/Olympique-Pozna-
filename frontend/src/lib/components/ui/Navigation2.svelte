...
<style>
/* ========================================
   NAVBAR OLYMPIQUE POZNAŃ - NAVIGATION2 BLEUE
   Mobile First avec fond bleu
   ======================================== */
...
.btn-login { background: rgba(255, 255, 255, 0.15); color: white; border: 1px solid rgba(255, 255, 255, 0.3); }
.btn-login:hover { background: rgba(255, 255, 255, 0.25); transform: translateY(-2px); }
.btn-register { background: #d4af37; color: #0f2d4a; }
.btn-register:hover { background: #c9a02d; transform: translateY(-2px); }
...
@media (min-width: 768px) and (min-height: 500px) {
  ...
  .nav-link:hover,
  .nav-link:focus { color: #d4af37; background: rgba(212, 175, 55, 0.2); }
...
.mobile-third-level-link:hover { background: rgba(212, 175, 55, 0.15); color: #d4af37; }
...
.mobile-third-level-trigger:hover { background: rgba(212, 175, 55, 0.15); color: #d4af37; }
