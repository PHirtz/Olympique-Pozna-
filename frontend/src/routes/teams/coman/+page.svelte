<svelte:head>
  <title>L'équipe Coman - Olympique Poznań</title>
  <meta name="description" content="Découvrez l'équipe Coman de l'Olympique Poznań" />
</svelte:head>
...
<div class="coman-page">
  <!-- Hero Section -->
  <section class="hero-coman">
    <div class="hero-background">
      <img src="/team/coman.jpg" alt="coman" class="hero-image" />
      <div class="hero-overlay"></div>
      <div class="hero-copyright">
        &copy; Action Press/SIPA
      </div>
    </div>
