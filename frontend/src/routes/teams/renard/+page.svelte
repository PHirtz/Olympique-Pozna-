<svelte:head>
  <title>L'équipe Wendie Renard - Olympique Poznań</title>
  <meta name="description" content="Découvrez l'équipe Wendie Renard de l'Olympique Poznań" />
</svelte:head>
...
<div class="renard-page">
  <!-- Hero Section -->
  <section class="hero-renard">
    <div class="hero-background">
      <img src="/team/wendie.jpg" alt="renard" class="hero-image" />
      <div class="hero-overlay"></div>
      <div class="hero-copyright">
        &copy; Naomi Baker/GettyImages
      </div>
    </div>
    <div class="hero-content">
      <h1>{$_('teams.renard')}</h1>
    </div>
  </section>
