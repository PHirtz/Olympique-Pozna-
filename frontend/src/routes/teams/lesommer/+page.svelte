<svelte:head>
  <title>L'équipe Eugénie Le Sommer - Olympique Poznań</title>
  <meta name="description" content="Découvrez l'équipe Eugénie Le Sommer de l'Olympique Poznań" />
</svelte:head>
...
<div class="lesommer-page">
  <!-- Hero Section -->
  <section class="hero-lesommer">
    <div class="hero-background">
      <img src="/team/eugenie.jpg" alt="lesommer" class="hero-image" />
      <div class="hero-overlay"></div>
      <div class="hero-copyright">
        &copy; FRANCK FIFE/AFP
      </div>
    </div>
    <div class="hero-content">
      <h1>{$_('teams.lesommer')}</h1>
    </div>
  </section>
