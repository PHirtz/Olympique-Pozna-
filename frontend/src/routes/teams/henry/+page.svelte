<svelte:head>
  <title>L'équipe Amandine Henry - Olympique Poznań</title>
  <meta name="description" content="Découvrez l'équipe Amandine Henry de l'Olympique Poznań" />
</svelte:head>
...
<div class="henry-page">
  <!-- Hero Section -->
  <section class="hero-henry">
    <div class="hero-background">
      <img src="/team/amandine.jpg" alt="henry" class="hero-image" />
