<svelte:head>
  <title>L'équipe Giroud - Olympique Poznań</title>
  <meta name="description" content="Découvrez l'équipe Giroud de l'Olympique Poznań" />
</svelte:head>
...
<div class="giroud-page">
  <!-- Hero Section -->
  <section class="hero-giroud">
    <div class="hero-background">
      <img src="/team/giroud.png" alt="Giroud" class="hero-image" />
      <div class="hero-overlay"></div>
      <div class="hero-copyright">
        &copy; Richard Sellers/GettyImages
      </div>
    </div>
    <div class="hero-content">
      <h1>{$_('teams.giroud')}</h1>
    </div>
  </section>
