<svelte:head>
  <title>L'équipe Kadidiatou Diani - Olympique Poznań</title>
  <meta name="description" content="Découvrez l'équipe Kadidiatou Diani de l'Olympique Poznań" />
</svelte:head>
...
<div class="diani-page">
  <!-- Hero Section -->
  <section class="hero-diani">
    <div class="hero-background">
      <img src="/team/diani.png" alt="diani" class="hero-image" />
