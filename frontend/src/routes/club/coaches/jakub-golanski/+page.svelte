<svelte:head>
  <title>{$_('coaches.jakub.name')} - {$_('coaches.title')}</title>
  <meta name="description" content={$_('coaches.jakub.tagline')} />
</svelte:head>
...
<div class="coach-page">
  ...
  <section class="hero-coach">
    <div class="hero-content">
      <img 
        src="/trener/jakub-trener.jpg" 
        alt={$_('coaches.jakub.name')} 
        class="coach-hero-photo"
      />
      <div class="hero-info">
        <h1>{$_('coaches.jakub.name')}</h1>
  ...
  <main class="main-content">
    <div class="container">
      ...
      <div class="highlight-box">
        <p class="since">⚽ {$_('coaches.jakub.since')}</p>
        <p class="motto">
          <Heart size={20} />
      ...
      <section class="section-block">
        <h2>{$_('coaches.jakub.formations.title')}</h2>
      ...
      <section class="section-block">
        <h2>{$_('coaches.jakub.experience.coach.title')}</h2>
      ...
      <section class="section-block">
        <h2>{$_('coaches.jakub.experience.player.title')}</h2>
        <ul class="compact-list">
          <li>TPS Winogrady</li>
          <li>TMS Suchary Suchy Las</li>
          <li>Złoci Złotkowo</li>
      ...
      <div class="quote-box">
        <h3>{$_('coaches.jakub.idol.title')}</h3>
        <p>{$_('coaches.jakub.idol.text')}</p>
      </div>

      <div class="highlight-box passion">
        <h3>{$_('coaches.jakub.passion.title')}</h3>
        <p>{$_('coaches.jakub.passion.text')}</p>
      </div>

      <div class="info-box">
        <h3>{$_('coaches.jakub.favorite_club.title')}</h3>
        <p>{$_('coaches.jakub.favorite_club.text')}</p>
      </div>

      <section class="qa-section">
        <h2>{$_('coaches.jakub.questions.title')}</h2>
