...
function Navigation($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<nav${attr_class("nav svelte-1huo92h", void 0, { "visible": visible })}${attr_style(`--nav-opacity: ${stringify(navOpacity)}; --text-opacity: ${stringify(navOpacity)}`)}><div class="nav-container svelte-1huo92h"><a href="/" class="logo-container svelte-1huo92h"><img src="/logo.png" alt="Logo Olympique Poznań" class="logo-olympique-poznan svelte-1huo92h"/></a> <a href="/" class="logo-container svelte-1huo92h"><img src="/home.png" alt="Logo Home" class="logo-home svelte-1huo92h"/></a> <div class="nav-links svelte-1huo92h"><a href="https://olympique.pl/" class="nav-link shop-link svelte-1huo92h" style="animation-delay: 0.2s">${escape_html(store_get($$store_subs ??= {}, "$_", $format)("nav.shop"))} <span class="new-badge svelte-1huo92h"><span class="badge-text svelte-1huo92h">NEW</span> <span class="shine svelte-1huo92h"></span></span></a> <div class="dropdown svelte-1huo92h" style="animation-delay: 0.3s" role="group"><a href="/club" class="nav-link dropdown-trigger svelte-1huo92h">${escape_html(store_get($$store_subs ??= {}, "$_", $format)("nav.club"))} `);
