...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!--]--> <button type="submit"${attr("disabled", loading, true)} class="svelte-7ke6fz">${escape_html("Envoyer le message")}</button></form> <div class="contact-info svelte-7ke6fz"><h3 class="svelte-7ke6fz">Autres moyens de nous contacter</h3> <div class="info-grid svelte-7ke6fz"><div class="info-item svelte-7ke6fz"><span class="icon svelte-7ke6fz">📧</span> <div><strong class="svelte-7ke6fz">Email</strong> <p class="svelte-7ke6fz">olympique.poznan@wielkopolskizpn.pl</p></div></div> <div class="info-item svelte-7ke6fz"><span class="icon svelte-7ke6fz">📞</span> <div><strong class="svelte-7ke6fz">Téléphone</strong> <p class="svelte-7ke6fz">+48 669 091 910</p></div></div> <div class="info-item svelte-7ke6fz"><span class="icon svelte-7ke6fz">📍</span> <div><strong class="svelte-7ke6fz">Adresse</strong> <p class="svelte-7ke6fz">Poznań, Pologne</p></div></div></div></div></div></section>`);
  });
}
export {
  _page as default
